...
class_name TabernaPostSokoban
extends Node2D

signal cinematic_finished

@export var dialogue: DialogueResource = preload("res://scenes/quests/story_quests/Anima/1_sokoban/TabernaComponents/PostSokoban.dialogue")
